...
def optuna_mse():
    ...
    data_base = Nacteni_image.data_load(
        r'C:\Users\andre\OneDrive\Plocha\School\BTB_3\Bakalářská práce\subjekty\pokus_1\manifest-data1407430404196\QIN Breast DCE-MRI\QIN-Breast-DCE-MRI-BC06\05-12-1997-NA-Breast CE-18265\07.000000-twist20sdynTRA h20 ex B17TT44.8s-78526')
    data_chang = Nacteni_image.data_load(
        r'C:\Users\andre\OneDrive\Plocha\School\BTB_3\Bakalářská práce\subjekty\pokus_1\manifest-data1407430404196\QIN Breast DCE-MRI\QIN-Breast-DCE-MRI-BC06\05-12-1997-NA-Breast CE-18265\45.000000-twist20sdynTRA h20 ex B17TT390.1s-32658')
    ...
    sitk.WriteTransform(final_transform, 'rigid_transform_mse_CE-18265.tfm')
    ...
    def objective_mse(trial):
        ...
        if score < mi_checking[0]:
            mi_checking[0] = score
            sitk.WriteTransform(bspline_final_transformation, 'best_transform_mse_CE-18265.tfm') #ulozi transformacni funkci,kdyz najde lespi - prepise
        return score
    ...
    def saving(study, trial):
        ...
        if study.best_trial.number == trial.number:
            with open('prubezne_ukladani_mse_18265.txt', 'w', encoding='utf-8') as f:
    ...
    study = optuna.create_study(direction='minimize',
                                study_name = 'mse_optimize_CE-18265',
                                storage = 'sqlite:///mse_optuna_CE-18265.db',
                                load_if_exists = True)
    study.optimize(objective_mse, n_trials=200, callbacks=[saving])
...
if __name__ == "__main__":
    ...
    with open('cas_vypoctu_optuny_mse_22159.txt', 'w', encoding='utf-8') as f:
        f.write(result)